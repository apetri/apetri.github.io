...
\begin{rSubsection}{Technical project}{Fall 2013}{Software engineering}{Columbia University, NY}
\item Implemented from scratch the client and server side components of a three tier simple database service, using the C language socket API
\end{rSubsection}
